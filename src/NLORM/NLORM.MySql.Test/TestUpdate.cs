...
namespace NETORM.MySql.Test
{
    ...
    public class TestUpdate
    {
        ...
        public TestUpdate()
        {
            connectionString = "Server=test.mysql.NETORM;Database=NETORM;uid=admin;pwd=1qaz;";
        }
        ...
        {
            var dbc = new NETORMMySqlDb(connectionString);
            createtable(dbc);
            insertdata(dbc);
        }

        private void insertdata(NETORMMySqlDb db)
        {
        ...
        private void createtable(NETORMMySqlDb db)
        {
            try
            {
        ...
        {
            var db = new NETORMMySqlDb(connectionString);
